...
const AppointmentTable = () => {
  ...
  // React Hook Form v7: pull errors from formState
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const makeBooking = (patientInfo) => {
    ...
    fetch(`${process.env.REACT_APP_BASE_URL}/makeBooking`, {
      method: 'POST',
      ...
      .then((res) => res.json())
      .then((data) => {
        contextAppointmentData.setAllBookedAppointments([
          ...contextAppointmentData.allBookedAppointments,
          data,
        ]);
      })
  ...
  const modalController = (apId) => {
    ...
    if (selectedAp) setSelectAppointment(selectedAp);
  };
        ...
        {isBooked ? (
          <div className="text-center py-5 my-5">
            ...
            <p className="mt-5 px-3">
              Please go to Dashboard and Login with your email which you provided into booking
              appointment to view details.
            </p>
